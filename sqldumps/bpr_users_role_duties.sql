...
INSERT INTO `role_duty_list` VALUES (1,'Role Structure','Struktur Peran','role-structure',1,'role-structure.png'),(2,'Authorities','Autoritas','authorities',1,'authorities.png'),(3,'Registration','Registrasi','registration',1,'registration.png'),(4,'Delegation','Delegasi','delegation',1,'delegation.png'),(5,'Marketing Report','Laporan Pemasaran','marketing-report',2,'marketing-report.png'),(6,'Receivables Report','Laporan Piutang','receivables-report',2,'receivable-report.png'),(7,'Taskforce Mobility Report','Laporan Mobilitas Gugus Tugas','taskforce-mobility-report',2,'taskforce-mobility-report.png'),(8,'Personal Mobility Report','Laporan Mobilitas Pribadi','personal-mobility-report',2,'personal-mobility-report.png'),(9,'Personal Achievement Report','Laporan Pencapaian Pribadi','personal-achievement-report',2,'personal-achiement-report.png'),(10,'Profile','Profil','profile',3,'profile.png'),(11,'Command Chains','Rantai Komando','command-chains',3,'command-chains.png'),(12,'Intercom','Interkom','intercom',3,'intercom.png');
...
--
-- Table structure for table `role_duty_groups`
--
...
--
-- Dumping data for table `role_duty_groups`
--

LOCK TABLES `role_duty_groups` WRITE;
/*!40000 ALTER TABLE `role_duty_groups` DISABLE KEYS */;
INSERT INTO `role_duty_groups` VALUES (1,'Administration','Administrasi'),(2,'Taskforce Performance','Kinerja Gugus Tugas'),(3,'Personal Activities','Aktivitas Pribady');
/*!40000 ALTER TABLE `role_duty_groups` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-09-10  5:44:38
